...
namespace UNet{
    ...
    void decode_kernel_invoker(
        float* predict, int num_classes, float confidence_threshold, 
        float* invert_affine_matrix, float* poutput,
    ...
    public:
        ...
        virtual vector<shared_future<cv::Mat>> commits(const vector<Mat>& images) override{
            return ControllerImpl::commits(images);
        }

        virtual std::shared_future<cv::Mat> commit(const Mat& image) override{
