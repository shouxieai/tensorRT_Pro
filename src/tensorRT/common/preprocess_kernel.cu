...
namespace CUDAKernel{
	...
	__global__ void warp_affine_bilinear_and_normalize_focus_kernel(uint8_t* src, int src_line_size, int src_width, int src_height, float* dst, int dst_width, int dst_height, 
		...
		// float m_x1 = warp_affine_matrix_1_3[0];
		// float m_y1 = warp_affine_matrix_1_3[1];
		// float m_z1 = warp_affine_matrix_1_3[2];
		// float m_x2 = warp_affine_matrix_1_3[3];
		// float m_y2 = warp_affine_matrix_1_3[4];
		// float m_z2 = warp_affine_matrix_1_3[5];
