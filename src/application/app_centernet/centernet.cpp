...
namespace CenterNet{
    ...
    void decode_kernel_invoker(float* predict, int num_boxes, int num_channels, int num_classes,
    ...
    public:
        ...
        virtual void worker(promise<bool>& result) override{
            ...
            int num_classes    = (output->size(2) - 4) / 2;
            int num_channels   = output->size(2);
            const int stride   = 4;
